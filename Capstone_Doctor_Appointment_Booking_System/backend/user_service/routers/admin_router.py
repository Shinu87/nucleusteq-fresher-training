...
from user_service.middleware.auth import CurrentUser, require_role
from user_service.schemas.request.doctor_request import RejectDoctorRequest
from user_service.schemas.response.doctor_response import (
    DoctorProfileResponse,
    to_doctor_profile_response,
)
from user_service.services import doctor_profile_service
