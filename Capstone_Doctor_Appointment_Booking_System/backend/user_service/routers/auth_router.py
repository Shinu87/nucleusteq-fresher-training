...
from user_service.middleware.auth import CurrentUser, get_current_user
from user_service.models.user import User
from user_service.schemas.request.auth_request import (
    LoginRequest,
    PatientRegisterRequest,
    SetPasswordRequest,
)
from user_service.schemas.request.doctor_request import DoctorRegisterRequest
from user_service.schemas.response.auth_response import TokenResponse, UserProfileResponse
from user_service.schemas.response.doctor_response import (
    DoctorProfileResponse,
    to_doctor_profile_response,
)
from user_service.services import auth_service, doctor_profile_service
from user_service.utils.jwt_handler import create_access_token
